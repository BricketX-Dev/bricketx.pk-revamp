...
const faqs = [
  ...
  },
  {
    ...
    a: "We continuously hire across eight primary disciplines: Developers (Full-Stack Next.js, API engineering), UI/UX Specialists, Graphic Designers, Performance Marketers, AI Prompt/Data Engineers, Operations Leads, Production Managers, and Department Leadership.",
  },
  {
    q: "What are BricketX Pakistan's values?",
    a: "We run on seven core principles: Educate First, Innovate Continuously, Operate With Excellence, Think Globally, Build For Scale, Never Stop Learning, and Always Improve.",
  },
  {
    q: "How do I apply to BricketX Pakistan?",
    a: "Select your discipline above or use our direct contact terminal to transmit your resume, GitHub profile, or portfolio link directly to the engineering leadership team in Karachi.",
  },
];
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-4xl">
        ...
        <div className="flex flex-col border-t border-zinc-800">
          {faqs.map((faq, idx) => {
            ...
            return (
              <div key={idx} className="faq-item border-b border-zinc-800 transition-colors">
                <button
